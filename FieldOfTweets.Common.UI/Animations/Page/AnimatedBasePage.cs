...
{
    public class AnimatedBasePage : LockBasePage
    {
        protected static readonly Uri ExternalUri = new Uri(@"app://external/");

        protected bool DontAnimatedOut;
        ...
        protected void AbortAnimations()
        {
            _isAnimating = false;
            _loadingAndAnimatingIn = false;
            CancelAnimation();
