...
namespace FieldOfTweets.Common.UI
{
    ...
    public static class ThemeManager
    {
        ...
        public static bool AppBarForegroundIsAccentColour { get; set; }
        ...
        public static void MatchOverriddenTheme(this IApplicationBar bar)
        {
            ...
            if (_applied) // Only if actually overrid the theme.
            {
            ...
            if (AppBarForegroundIsAccentColour)
                bar.ForegroundColor = _accentColor;
        ...
        private static uint AccentColorEnumToColorValue(AccentColor accent)
        {
            switch (accent)
            {
                ...
                case AccentColor.Mehdoh:
                    return 0xFF027231;

                case AccentColor.Twitter:
                    return 0xFF00ACEE;
